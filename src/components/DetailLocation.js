...
import { sendRequestControl } from '../services/listenEventSocket.io';
import { FEED_CONDITION, FEED_DOOR, FEED_LED } from '../configs/configMqtt';


export default function DetailLocation() {
  const { equipment } = useSelector(state => state.warehouse)
